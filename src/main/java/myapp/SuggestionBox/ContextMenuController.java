...
public class ContextMenuController {
    ...
    private void initialize(){
        Platform.runLater(()->{
            if(Main.mainController.getModified() == "normal"){modify.setText("     Add to favorite");}
            else{modify.setText("  Remove from favorite");}
        });
    }
    ...
    private void handleOption(String option) throws IOException {
        ...
        if(option == "FavoriteWord"){
            ...
            if(Main.mainController.getModified() == "normal"){
